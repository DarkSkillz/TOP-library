...
function Book(title, author, pages, genres, read, rating) {
     if (!new.target) {
...
function addBookToLibrary(title, author, pages, genres, read, rating) {
    const newBook = new Book(title, author, pages, genres, read, rating)
...
function addBookToCase(element) {
    ...
    bookCover.append(genreList, readStatus, rating, pageCount)
...
submitBtn.addEventListener("click", (e) => {
    ...
    if (objectData.title == "" || objectData.author == "") {
        ...
        addBookToLibrary(objectData.title, objectData.author, objectData.pages, genreString, objectData.readS, objectData.rating, objectData.cover)
